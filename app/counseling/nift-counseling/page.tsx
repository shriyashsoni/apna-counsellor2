...
export const metadata: Metadata = generateCounselingMeta({
  examName: 'NIFT',
  pageType: 'Counseling',
  slug: 'counseling/nift-counseling',
});

export default function NiftCounselingPage() {
  const jsonLd = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is NIFT Design Counseling?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "NIFT Design Counseling is the official process for admission to colleges under NIFT. It involves registration, document verification, and seat allotment."
        }
      },
      {
        "@type": "Question",
        "name": "How to apply for NIFT 2025 counseling?",
        "acceptedAnswer": {
          "@type": "Answer",
  ...
  return (
    <main className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="mb-12">
        <h1 className="text-4xl md:text-5xl font-black text-slate-900 mb-4">NIFT Design Counseling 2025 | Apna Counsellor</h1>
        <div className="h-1.5 w-24 bg-blue-600 rounded-full"></div>
      </div>
      
      <section className="prose prose-slate max-w-none mb-12">
        <p className="text-lg leading-relaxed text-slate-700">
          Welcome to the definitive guide for <strong>NIFT Design Counseling 2025</strong>. At Apna Counsellor, we provide end-to-end support for students navigating the complex landscape of college admissions in India. The NIFT Design Counseling is a critical phase where your rank is transformed into a career-defining seat at a top-tier institution. Whether you are aiming for NIFT top colleges or looking for the best possible options within your rank, our expert insights and data-driven approach ensure you stay ahead of the competition. 
        </p>
        <p className="text-lg leading-relaxed text-slate-700 mt-4">
          The 2025 session of NIFT Design Counseling is expected to be highly competitive. It is essential to understand the CAP rounds, seat matrix, and category-wise cutoffs. Our platform offers free tools like college predictors and rank analysis to help you make informed choices. Join thousands of successful students who have used Apna Counsellor to secure their dream college seats.
        </p>
      </section>
      ...
      <RelatedLinks pageSlug="nift-counseling" />
    </main>
  );
}
