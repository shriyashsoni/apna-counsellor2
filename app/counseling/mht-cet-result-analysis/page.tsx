...
export const metadata: Metadata = generateCounselingMeta({
  examName: 'MHT-CET',
  pageType: 'Result Analysis',
  slug: 'counseling/mht-cet-result-analysis',
});

export default function MHTCETResultAnalysisPage() {
  const jsonLd = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is MHT-CET Result Analysis?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "MHT-CET Result Analysis is an essential part of the admission process for students seeking seats in top colleges in India. It involves multiple stages including registration and allotment."
        }
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        "name": "When will MHT-CET Result Analysis start?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "The Result Analysis process for MHT-CET 2025 is expected to commence shortly after the declaration of results. Stay tuned for official updates."
        }
      },
      {
        "@type": "Question",
  ...
  const breadcrumbLd = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 3, "name": "MHT-CET Result Analysis", "item": "https://www.apnacounsellor.in/counseling/mht-cet-result-analysis" }
    ]
  };
    ...
    <main className="max-w-4xl mx-auto px-4 py-12">
      ...
      <section className="mb-12">
        ...
        <div className="bg-slate-50 p-6 rounded-lg border border-slate-200">
          <p>The official schedule for MHT-CET Result Analysis 2025 will be announced soon. Generally, the process follows these stages:</p>
      ...
      <section className="mb-12">
        ...
        <div className="p-6 border rounded-lg bg-white shadow-sm">
          <p>To participate in the MHT-CET Result Analysis 2025, candidates must fulfill the following criteria:</p>
      ...
      <RelatedLinks pageSlug="mht-cet-result-analysis" />
    </main>
  );
}
