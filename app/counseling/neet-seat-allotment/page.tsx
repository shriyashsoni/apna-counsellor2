...
export const metadata: Metadata = generateCounselingMeta({
  ...
  slug: 'counseling/neet-seat-allotment',
});

export default function NEETSeatAllotmentPage() {
  const jsonLd = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is NEET Seat Allotment?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "NEET Seat Allotment is an essential part of the admission process for students seeking seats in top colleges in India. It involves multiple stages including registration and allotment."
        }
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        "name": "When will NEET Seat Allotment start?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "The Seat Allotment process for NEET 2025 is expected to commence shortly after the declaration of results. Stay tuned for official updates."
        }
      },
      {
        "@type": "Question",
  ...
  const breadcrumbLd = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 3, "name": "NEET Seat Allotment", "item": "https://www.apnacounsellor.in/counseling/neet-seat-allotment" }
    ]
  };
    ...
    <main className="max-w-4xl mx-auto px-4 py-12">
      ...
      <section className="mb-12">
        ...
        <div className="bg-slate-50 p-6 rounded-lg border border-slate-200">
          <p>The official schedule for NEET Seat Allotment 2025 will be announced soon. Generally, the process follows these stages:</p>
      ...
      <section className="mb-12">
        ...
        <div className="p-6 border rounded-lg bg-white shadow-sm">
          <p>To participate in the NEET Seat Allotment 2025, candidates must fulfill the following criteria:</p>
      ...
      <RelatedLinks pageSlug="neet-seat-allotment" />
    </main>
  );
}
