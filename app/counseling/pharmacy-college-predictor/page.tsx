...
export const metadata: Metadata = generateCounselingMeta({
  ...
  slug: 'counseling/pharmacy-college-predictor',
});

export default function PharmacyCollegePredictorPage() {
  const jsonLd = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is Pharmacy College Predictor?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Pharmacy College Predictor is an essential part of the admission process for students seeking seats in top colleges in India. It involves multiple stages including registration and allotment."
        }
      },
      {
        "@type": "Question",
        "name": "How to participate in Pharmacy 2025 counseling?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "When will Pharmacy College Predictor start?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "The College Predictor process for Pharmacy 2025 is expected to commence shortly after the declaration of results. Stay tuned for official updates."
        }
      },
      {
        "@type": "Question",
        "name": "What are the documents required for Pharmacy?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Commonly required documents include the Pharmacy scorecard, admit card, 10th & 12th certificates, and identity proof."
        }
      },
      {
        "@type": "Question",
  ...
  const breadcrumbLd = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 3, "name": "Pharmacy College Predictor", "item": "https://www.apnacounsellor.in/counseling/pharmacy-college-predictor" }
    ]
  };
    ...
    <main className="max-w-4xl mx-auto px-4 py-12">
      ...
      <section className="mb-12">
        ...
        <div className="bg-slate-50 p-6 rounded-lg border border-slate-200">
          <p>The official schedule for Pharmacy College Predictor 2025 will be announced soon. Generally, the process follows these stages:</p>
      ...
      <section className="mb-12">
        ...
        <div className="p-6 border rounded-lg bg-white shadow-sm">
          <p>To participate in the Pharmacy College Predictor 2025, candidates must fulfill the following criteria:</p>
          <ul className="mt-4 space-y-2 list-disc list-inside text-slate-600">
            <li>Qualified Pharmacy 2025 with a valid rank/score.</li>
      ...
      <RelatedLinks pageSlug="pharmacy-college-predictor" />
    </main>
  );
}
