...
export const metadata: Metadata = generateCounselingMeta({
  ...
  slug: 'counseling/josaa-cutoff-2025',
});

export default function JoSAACutoffPage() {
  const jsonLd = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is JoSAA Cutoff 2025?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "JoSAA Cutoff 2025 is an essential part of the admission process for students seeking seats in top colleges in India. It involves multiple stages including registration and allotment."
        }
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        "name": "When will JoSAA Cutoff 2025 start?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "The Cutoff 2025 process for JoSAA 2025 is expected to commence shortly after the declaration of results. Stay tuned for official updates."
        }
      },
      {
        "@type": "Question",
  ...
  const breadcrumbLd = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 3, "name": "JoSAA Cutoff 2025", "item": "https://www.apnacounsellor.in/counseling/josaa-cutoff-2025" }
    ]
  };
    ...
    <main className="max-w-4xl mx-auto px-4 py-12">
      ...
      <section className="mb-12">
        ...
        <div className="bg-slate-50 p-6 rounded-lg border border-slate-200">
          <p>The official schedule for JoSAA Cutoff 2025 2025 will be announced soon. Generally, the process follows these stages:</p>
      ...
      <section className="mb-12">
        ...
        <div className="p-6 border rounded-lg bg-white shadow-sm">
          <p>To participate in the JoSAA Cutoff 2025 2025, candidates must fulfill the following criteria:</p>
      ...
      <RelatedLinks pageSlug="josaa-cutoff-2025" />
    </main>
  );
}
