...
export const metadata: Metadata = generateCounselingMeta({
  examName: 'NEET',
  pageType: 'Stray Vacancy Round',
  slug: 'counseling/neet-stray-vacancy-round',
});

export default function NEETStrayVacancyRoundPage() {
  const jsonLd = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is NEET Stray Vacancy Round?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "NEET Stray Vacancy Round is an essential part of the admission process for students seeking seats in top colleges in India. It involves multiple stages including registration and allotment."
        }
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        "name": "When will NEET Stray Vacancy Round start?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "The Stray Vacancy Round process for NEET 2025 is expected to commence shortly after the declaration of results. Stay tuned for official updates."
        }
      },
      {
        "@type": "Question",
  ...
  const breadcrumbLd = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 3, "name": "NEET Stray Vacancy Round", "item": "https://www.apnacounsellor.in/counseling/neet-stray-vacancy-round" }
    ]
  };
    ...
    <main className="max-w-4xl mx-auto px-4 py-12">
      ...
      <section className="mb-12">
        ...
        <div className="bg-slate-50 p-6 rounded-lg border border-slate-200">
          <p>The official schedule for NEET Stray Vacancy Round 2025 will be announced soon. Generally, the process follows these stages:</p>
      ...
      <section className="mb-12">
        ...
        <div className="p-6 border rounded-lg bg-white shadow-sm">
          <p>To participate in the NEET Stray Vacancy Round 2025, candidates must fulfill the following criteria:</p>
      ...
      <RelatedLinks pageSlug="neet-stray-vacancy-round" />
    </main>
  );
}
