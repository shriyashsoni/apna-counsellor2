...
export const metadata: Metadata = generateCounselingMeta({
  examName: 'NEET UG',
  pageType: 'Counseling',
  slug: 'counseling/tamilnadu-neet-counseling',
});

export default function TamilnaduNeetCounselingPage() {
  const jsonLd = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is Tamil Nadu NEET State Counseling?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Tamil Nadu NEET State Counseling is the official process for admission to colleges under NEET UG. It involves registration, document verification, and seat allotment."
        }
      },
      {
        "@type": "Question",
  ...
  return (
    <main className="max-w-4xl mx-auto px-4 py-12">
      ...
      <RelatedLinks pageSlug="tamilnadu-neet-counseling" />
    </main>
  );
}
