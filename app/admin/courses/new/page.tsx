  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500 pb-20">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-xl font-black text-white tracking-tight">Launch Admission Course</h1>
          <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">7-Step Program Deployment Wizard</p>
        </div>
      </div>
