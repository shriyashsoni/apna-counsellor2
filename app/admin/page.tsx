              ...
              <Card key={stat.label} className="bg-slate-900 border-slate-800 rounded-[2rem] overflow-hidden">
                <CardContent className="p-8">
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <Badge variant="outline" className="border-slate-800 text-slate-500 text-[10px] font-black uppercase">+12%</Badge>
                  </div>
              ...
              <Card className="bg-slate-900 border-slate-800 rounded-[2.5rem]">
                <CardHeader className="p-10 border-b border-slate-800 flex flex-row items-center justify-between">
                  ...
                  <div className="relative w-full max-w-[300px]">
                    ...
                    <Input placeholder="Search applicants..." className="bg-slate-950 border-slate-800 pl-11 rounded-xl h-12" />
                  </div>
                </CardHeader>
                            ...
                            <tr key={mentor._id} className="hover:bg-slate-950/50 transition-colors">
                              <td className="px-10 py-6">
                                <div className="flex items-center gap-4">
                                  <img src={mentor.image || "https://github.com/shadcn.png"} className="h-12 w-12 rounded-2xl" />
                                  <div>
                              ...
                              <td className="px-10 py-6">
                                <div className="flex gap-2">
                                  {mentor.skills?.slice(0, 2).map((s: string) => (
                                    <Badge key={s} className="bg-primary/10 text-primary border-none text-[9px] font-bold">{s}</Badge>
                                  ))}
                                </div>
                              </td>
                              <td className="px-10 py-6">
                                <p className="text-sm font-bold">{mentor.college}</p>
                                <p className="text-[10px] text-slate-500 uppercase font-black">{mentor.year} Year</p>
                              </td>
                              <td className="px-10 py-6 text-right space-x-3">
                                ...
                                <Button 
                                  ...
                                  className="h-10 px-6 rounded-xl font-black bg-emerald-500 text-white hover:bg-emerald-600"
                                >
                                  Approve
                                </Button>
                              </td>
