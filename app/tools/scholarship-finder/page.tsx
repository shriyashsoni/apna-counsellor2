...
export const metadata: Metadata = {
  title: 'Scholarship Finder | Apna Counsellor',
  description: 'Use our advanced Scholarship Finder to find the best colleges and branches for your rank in 2025.',
};
...
export default function ScholarshipFinderPage() {
  ...
  const howToSchema = {
    "@context": "https://schema.org",
    "@type": "HowTo",
    "name": "How to use Scholarship Finder",
    "step": [
  ...
  return (
    <main className="max-w-4xl mx-auto px-4 py-12">
      ...
      <h1 className="text-4xl font-bold mb-8">Scholarship Finder 2025</h1>
      <p className="text-xl text-slate-600 mb-12">Coming soon: Our data-driven Scholarship Finder will help you make the right choice.</p>
      
      <div className="bg-slate-100 h-96 flex items-center justify-center rounded-2xl border-2 border-dashed border-slate-300">
        <p className="text-slate-500 font-medium">Interactive Scholarship Finder Component UI</p>
      </div>
    </main>
  );
}
