...
export default function AuthCodeErrorPage() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-950 p-4">
      <Suspense fallback={
        <Card className="w-full max-w-md border-none shadow-2xl rounded-[2.5rem] bg-white dark:bg-slate-900 p-12 text-center">
           <RefreshCw className="h-10 w-10 animate-spin text-primary mx-auto mb-4" />
           <p className="text-slate-500 font-bold">Loading error details...</p>
        </Card>
      }>
